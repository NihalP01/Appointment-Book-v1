...
class AdminPanelRejectedAdapter :
    RecyclerView.Adapter<AdminPanelRejectedAdapter.RejectedViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdminPanelRejectedAdapter.RejectedViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.req_rejected_items, parent, false)
        return RejectedViewHolder(view)
    }

    override fun onBindViewHolder(
        holder: AdminPanelRejectedAdapter.RejectedViewHolder,
        position: Int
    ) {
