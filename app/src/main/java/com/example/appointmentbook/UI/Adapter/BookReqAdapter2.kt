...
class BookReqAdapter2 : RecyclerView.Adapter<BookReqAdapter2.ReqViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookReqAdapter2.ReqViewHolder, position: Int) {
    ...
    inner class ReqViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: BookRequestDataItem, position: Int) {
            ...
            btnContact.setOnClickListener {
                this@BookReqAdapter2.btnContact?.invoke(position, data)
            }
        }
